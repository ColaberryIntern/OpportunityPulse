module.exports = (sequelize) => {
  ...
  const AnalysisRun = sequelize.define('AnalysisRun', {
    ...
    type: {
      ...
      allowNull: false,
      validate: {
        isIn: [['scoring', 'trend_detection', 'insight_generation', 'ai_tool_mention_extraction', 'ai_tool_trend_analysis', 'ai_tool_github_discovery', 'ai_tool_producthunt_discovery', 'classification', 'saturation_computation', 'action_recommendation', 'executive_brief', 'domain_classification', 'capability_classification', 'strategic_intent', 'monetization_angle', 'maturity_phase', 'geographic_tagging', 'meta_signal_computation', 'cluster_detection']],
      },
    },
    status: {
