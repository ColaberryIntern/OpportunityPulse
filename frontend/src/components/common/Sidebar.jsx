...
const NAV_ITEMS = [
  ...
  { to: '/for-you', label: 'For You', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
  ...
  { to: '/executive-brief', label: 'Executive Brief', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { to: '/opportunities', label: 'Opportunities', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
...
function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <aside
        className={`fixed top-14 left-0 bottom-0 w-56 bg-primary z-40 transform transition-transform lg:translate-x-0 ${
          open ? 'translate-x-0' : '-translate-x-full'
        } lg:static lg:z-auto`}
        aria-label="Main navigation"
      >
        <nav className="flex flex-col gap-1 p-3 mt-2" aria-label="Primary navigation">
