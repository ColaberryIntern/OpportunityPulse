...
import { getBonfireReadiness } from '../../services/documentService';
    ...
    <div className="mb-4 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-200">v0.1</span>
        </div>
      ...
      <div className="px-4 py-3">
            ...
            return (
              <li key={item.type} className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-gray-900 dark:text-gray-100">{item.type_label}</div>
                  {item.reason && (
        ...
        <div className="mt-3 text-[11px] text-gray-500 dark:text-gray-400">
          v0.1 uses a fixed Bonfire checklist. <Link to="/admin/documents" className="text-blue-700 dark:text-blue-300 hover:underline">Manage documents →</Link>
        </div>
      </div>
    </div>
  );
