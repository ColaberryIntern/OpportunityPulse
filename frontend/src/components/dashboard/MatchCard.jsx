...
function MatchCard({ match }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow">
      <Link to={`/opportunities/${opp.id}`} className="block p-4 pb-2">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            {/* Title */}
            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1 line-clamp-2 hover:text-accent">
              {opp.title}
            </h3>
      ...
      {/* Feedback buttons — outside the Link to prevent navigation */}
